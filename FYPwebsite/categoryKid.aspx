<%@ Page Language="C#" AutoEventWireup="true" CodeFile="categoryKid.aspx.cs" Inherits="Index_" %>
...
<body>
    <form id="form1" runat="server">
       <div id="container">
        ...
        <div id="header">
            <div id="logo"><a href="Index_.aspx"><p style="line-height:95px;"><b>BuyZone</b></p></a></div>
 ...
 <li><a href="Index_.aspx">Home</a></li>
        ...
        <div id="ProductBanner">
            <img src="KidBanner.jpg" style="height:450px; width:100%; background-size:100% 100%;" /> 
        </div>
        ...
        <div id="ProductContent">
            ...
            <div class="contentbox">
               <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 Winter Dress Baby Boy Hoodie Buy Online at Best Prices in Pakistan Daraz pk.png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Baby Boy Hoodie</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 2019 Infant Newborn Baby Boy Girls Clothes Camo Print T-shirt Tops Long Pants Headband Outfits Set Ba[...].png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Camo Print T-shirt</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 Boys Gentleman Solid Infant Baby T Shirt Suspenders Strap Pants Set Outfits Buy Online at Best Prices[...].png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Boys Gentleman Solid</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 Boys winter dress 6 month to 4 years Buy Online at Best Prices in Pakistan Daraz pk.png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Boys winter dress</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 New Kids Dresses I Love Papa and Mama Dresses for Kids Buy Online at Best Prices in Pakistan Daraz pk.png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">New Kids Dresses</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 KID'S SUMMER STITCHED KURTA SHALWAR Buy Online at Best Prices in Pakistan Daraz pk.png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Kurta Shalwar</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 Velvet Winter Dresses for Boys Buy Online at Best Prices in Pakistan Daraz pk.png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Velvet Winter Dresses</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
            ...
            <div class="contentbox">
                <div class="productImage">
                    <img src="Kids/Screenshot_2020-01-27 pajama set for baba pack of 3 Buy Online at Best Prices in Pakistan Daraz pk.png" style="height:298px; width:100%; background-size:100% 100%;" /> 
               </div>
                <div class="productText">
                    <table style="text-align:center;">
                    <tr><td><span  style="margin-left:130px;">Pajama Set</span></td></tr>
                    <tr><td><span  style="margin-left:130px; color:red;">1000 RPs</span></td></tr>
